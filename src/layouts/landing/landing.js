  ...
  return (
    <div>
      ...
      <div className="landing-image">
        <div className="container pt-4 custom-center">
          <h1 className="display-1 font-1 text-primary mb-3">THE-GRID</h1>
          <h3 className="font-2 text-dark mt-4 mb-2">
            World's first public EV charging network.
          </h3>
          <h4 className="font-3 text-light my-5">
            Built with <img style={{height:'7vh'}} src={Tron} />
          </h4>
          <button
            className="btn btn-success fw-bold landing-btn font-3 btn-lg"
            onClick={() => {
              navigate("/signup");
            }}
          >
          ...
          <button
            className="btn btn-outline-primary ms-3 fw-bold landing-btn font-3 btn-lg"
            onClick={() => {
              navigate("/login");
            }}
          >
      ...
      <div className="my-5 py-4 container text-center">
        <h1 className="text-secondary font-2">
        ...
        <table className="table borderless font-3 my-5 text-success">
          <tbody>
            ...
            <td className="h3">
              <motion.h3 whileHover={{ scale: 1.4 }} whileTap={{ scale: 0.9 }}>
                Chennai
              </motion.h3>
            </td>
            <td className="h3">
            ...
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <div className="mt-5 card shadow p-4">
                ...
                <p className="text-muted mb-0">
                  Separated by Region - United by Service
                </p>
              </div>
            </motion.div>
          </div>
          <div className="col-md-4 text-center">
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <div className="mt-5 card shadow p-4">
                ...
                <p className="text-muted mb-0">
                  Transaction are secure and fast
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <footer className="bg-primary py-5 mt-5">
        <div className="container">
          ...
          <div className="small text-center text-light font-4">
            Copyright © Then, Now & Forever - THE-GRID
          </div>
        </div>
      </footer>
    </div>
